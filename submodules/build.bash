...
(cd ./wireguard-tools/src && make clean && PLATFORM=darwin V=1 CC=/usr/local/osxcross/bin/o64-clang make && cp ./wg ../../../dist/prebuilds/darwin-wg && chmod +x ../../../dist/prebuilds/darwin-wg)
