 ...
 * However, all of the client's traffic will be tunneled through the server.
 *
 ...
 * be ran with:
 *
 * Tsx examples/generate-remote-tunneled-access.ts
 */
...
export const program = (
    ...
    lanNetworkCidr: (typeof InternetSchemas.IPv4CidrBlockFromString)["Encoded"] = "192.168.1.1/24" as const,
...
> =>
    Effect.gen(function* () {
        ...
        const decodeAddress = Schema.decodeEffect(InternetSchemas.IPv4);
